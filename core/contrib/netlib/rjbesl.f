...
CS    DATA ONE30, THREE5 /130.0E0,35.0E0/
      DATA PI2, TWOPI1, TWOPI2 /0.636619772367581343075535D0,6.28125D0,     CD
     1 1.935307179586476925286767D-3/                                       CD
      DATA ZERO, EIGHTH, HALF, ONE /0.0D0,0.125D0,0.5D0,1.0D0/              CD
      DATA TWO, THREE, FOUR, TWOFIV /2.0D0,3.0D0,4.0D0,25.0D0/              CD
      DATA ONE30, THREE5 /130.0D0,35.0D0/                                   CD
C---------------------------------------------------------------------
C  Machine-dependent parameters
C---------------------------------------------------------------------
CS    DATA ENTEN, ENSIG, RTNSIG /1.0E38,1.0E8,1.0E-2/
CS    DATA ENMTEN, XLARGE /1.2E-37,1.0E4/
      DATA ENTEN, ENSIG, RTNSIG /1.0D38,1.0D17,1.0D-4/                      CD
      DATA ENMTEN, XLARGE /1.2D-37,1.0D4/                                   CD
C---------------------------------------------------------------------
C     Factorial(N)
C---------------------------------------------------------------------
...
CS   5 2.585201673888497664E22,6.2044840173323943936E23/
      DATA FACT /1.0D0,1.0D0,2.0D0,6.0D0,24.0D0,1.2D2,7.2D2,5.04D3,         CD
     1 4.032D4,3.6288D5,3.6288D6,3.99168D7,4.790016D8,6.2270208D9,          CD
     2 8.71782912D10,1.307674368D12,2.0922789888D13,3.55687428096D14,       CD
     3 6.402373705728D15,1.21645100408832D17,2.43290200817664D18,           CD
     4 5.109094217170944D19,1.12400072777760768D21,                         CD
     5 2.585201673888497664D22,6.2044840173323943936D23/                    CD
C---------------------------------------------------------------------
